...
import com.ecotech.plantae.shared.application.security.AccountTypeGuard;
...
public class HomeDashboardController {
    ...
    public ResponseEntity<MessageResponse> registerManualAction(@RequestHeader(value = "Accept-Language", required = false) String acceptLanguage,
