...
public class Sensor {
    ...
    public static Sensor register(SensorType type, String ownerId) {
        Objects.requireNonNull(ownerId, "Owner id is required");
        return new Sensor(SensorId.newId(), type, SensorStatus.ACTIVE, null, ownerId, null, Instant.now(), Instant.now());
    }
