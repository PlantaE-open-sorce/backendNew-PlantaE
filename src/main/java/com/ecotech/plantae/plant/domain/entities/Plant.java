...
public class Plant {
    ...
    private Plant(PlantId id, String ownerId, String name, String species, String location,
    ...
    public static Plant create(String ownerId, String name, String species, String location, String sensorId) {
        return new Plant(PlantId.newId(), ownerId, name, species, location, sensorId, PlantStatus.ACTIVE, false,
                Instant.now(), Instant.now(), null);
    }

    public static Plant restore(PlantId id, String ownerId, String name, String species, String location,
            String sensorId, PlantStatus status, boolean hasAlerts,
            Instant createdAt, Instant updatedAt, Instant deletedAt) {
        return new Plant(id, ownerId, name, species, location, sensorId, status, hasAlerts, createdAt, updatedAt,
                deletedAt);
    }
    ...
    public void updateDetails(String name, String species, String sensorId, PlantStatus status, String location) {
        if (name != null) {
            this.name = requireNonBlank(name, "Plant name is required");
        }
        if (species != null) {
