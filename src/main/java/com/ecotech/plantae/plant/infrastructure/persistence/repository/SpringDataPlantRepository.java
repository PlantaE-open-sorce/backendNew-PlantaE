...
public interface SpringDataPlantRepository
        extends JpaRepository<PlantJpaEntity, String>, JpaSpecificationExecutor<PlantJpaEntity> {
    Optional<PlantJpaEntity> findByIdAndOwnerId(String id, String ownerId);

    java.util.List<PlantJpaEntity> findByOwnerIdAndDeletedAtIsNull(String ownerId);
}
